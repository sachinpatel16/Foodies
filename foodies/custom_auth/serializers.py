...
from foodies.custom_auth.models import (ApplicationUser, CustomPermission
                                        )
from foodies.utils.validation import UniqueNameMixin

from foodies.utils.email_send import Util
...
class BaseUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "uuid", "phone", "fullname", "first_name","last_name", "email", 
                    "photo", "address", "area", "pin", "city", "state",
                    "password", "is_active")
