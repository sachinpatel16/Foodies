...
MIDDLEWARE = [
    ...
    'foodies.custom_auth.middleware.TokenBlacklistMiddleware',
...
AUTHENTICATION_BACKENDS = (
    'foodies.custom_auth.auth_backends.model_backend.CustomModelBackend',
)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        'foodies.utils.renderer.CustomRenderer'
    ],
    'PAGE_SIZE': 10,
    'DEFAULT_PAGINATION_CLASS': 'foodies.utils.paginator.CustomPagination',
}

# Project name
# ------------
PROJECT_FULL_NAME = env('PROJECT_FULL_NAME', default='foodies')

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            root('foodies', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Bartr",

    # Copyright on the footer
    "copyright": "Bartr Club",
