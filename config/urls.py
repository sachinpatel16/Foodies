...
schema_view = get_schema_view(
    openapi.Info(
        title="Foodies",
        default_version='v1',
        description="API documentation for Foodies",
...
urlpatterns = [
    ...
    path('api/', include([
        # path('registration/', include('foodies.registrations.api_urls')),
        path('custom_auth/', include('foodies.custom_auth.api_urls')),
        # path('v1/', include([
        #     path('merchant/', include('foodies.merchant.api_urls')),
        #     path('customer/', include('foodies.customer.api_urls')),
        # ])),
    ])),
